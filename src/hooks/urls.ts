...
export enum Chevereto {
  UploadPath = "/api/1/upload",
}
...
export enum Imgur {
  ...
  AppSettingsPage = "https://imgur.com/account/settings/apps",
}

export enum Raycast {
  OAuthCallack = "https://raycast.com/redirect?packageName=Extension",
}
